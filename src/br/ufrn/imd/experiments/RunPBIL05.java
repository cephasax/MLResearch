...
public class RunPBIL05 {

	private static int maxTime = 60; 						// in minutes
	private static int numRepetitions = 2;					// default = 10 mas, preciso baixar p/ 5
	private static int numFoldsEvaluate = 5;				// número de folds 10 default
	private static int numFoldsFitness = 10;
	private static String output_name = "PBIL_exp6-6";		// nome do arquivo csv					
	...
	private static double[] learning = { 0.5}; 				//private static double[] learning = { 0.001, 0.05, 0.1, 0.5 };
	...
	private static String[] base_name = {"resources/Adult.arff", "resources/Arrhythmia.arff", "resources/Ecoli.arff", "resources/Nursery.arff", "resources/Sonar.arff"};
