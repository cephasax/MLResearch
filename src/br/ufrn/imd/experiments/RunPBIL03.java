...
public class RunPBIL03 {

	private static int maxTime = 45; 						// in minutes
	private static int numRepetitions = 3;					// default = 10 mas, preciso baixar p/ 5
	private static int numFoldsEvaluate = 10;				// número de folds 10 default
	private static int numFoldsFitness = 10;
	private static String output_name = "exp3-3";
	private static int[] iterations = { 20 };  				// gerações = { 20, 50, 100 };
	private static int[] population_size = { 50, 100 };		// população = {10, 20, 30, 50, 70, 100}
	...
	private static String[] base_name = { "resources/Adult.arff", "resources/Arrhythmia.arff"};
