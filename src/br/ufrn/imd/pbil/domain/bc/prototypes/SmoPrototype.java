...
public class SmoPrototype extends ClassifierPrototype {
	public SmoPrototype() throws InvalidParameterTypeException {
		...
		sel.setPossibilities(Arrays.asList("Default", 
					"weka.classifiers.functiosn.supportVector.NormalizedPolyKernel -E 2.0 -C 250007",
					"weka.classifiers.functiosn.supportVector.PolyKernel -E 1.0 -C 250007", 
					"weka.classifiers.functiosn.supportVector.Puk -O 1.0 -C 250007", 
					"weka.classifiers.functiosn.supportVector.RBFKernel -C 250007 -G 0.01 "));
