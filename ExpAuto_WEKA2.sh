...
java $args -cp ".:$jars" $app "KR-vs-KP.arff" Auto_WEKA 123 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "KR-vs-KP.arff" Auto_WEKA 250 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "KR-vs-KP.arff" Auto_WEKA 377 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Arrhythmia.arff" Auto_WEKA 123 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Arrhythmia.arff" Auto_WEKA 250 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Arrhythmia.arff" Auto_WEKA 377 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Nursery.arff" Auto_WEKA 123 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Nursery.arff" Auto_WEKA 250 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Nursery.arff" Auto_WEKA 377 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Secom.arff" Auto_WEKA 123 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Secom.arff" Auto_WEKA 250 V2_ResAuto_WEKA2.txt
...
java $args -cp ".:$jars" $app "KR-vs-KP.arff" Auto_WEKA 631 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Arrhythmia.arff" Auto_WEKA 504 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Arrhythmia.arff" Auto_WEKA 631 V2_ResAuto_WEKA2.txt
java $args -cp ".:$jars" $app "Nursery.arff" Auto_WEKA 504 V2_ResAuto_WEKA2.txt
